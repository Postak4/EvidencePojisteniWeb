...
namespace EvidencePojisteniWeb.Data.Migrations
{
    ...
    [Migration("20250710090812_ApplicationUser.PojistenecModelId")]
    partial class ApplicationUserPojistenecModelId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EvidencePojisteniWeb.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("PojistenecModelId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PojistenecModelId")
                        .IsUnique()
                        .HasFilter("[PojistenecModelId] IS NOT NULL");
            ...
            modelBuilder.Entity("EvidencePojisteniWeb.Models.ApplicationUser", b =>
                {
                    b.HasOne("EvidencePojisteniWeb.Models.PojistenecModel", "Pojistenec")
                        .WithOne("User")
                        .HasForeignKey("EvidencePojisteniWeb.Models.ApplicationUser", "PojistenecModelId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EvidencePojisteniWeb.Models.ApplicationUser", null)
                        .WithMany()
